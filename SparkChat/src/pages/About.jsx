  ...
  return (
    <div className="bg-black min-h-screen flex flex-col text-white/70   p-5 gap-10 poppins-regular">
      <div className="flex   w-[80vw] md:w-max">
        ...
        />
        <h1 className="text-3xl lg:text-5xl text-center text-white/70 ">
          About
        </h1>
      </div>
      <div className="flex flex-col min-h-screen justify-normal items-center  space-y-2 px-5">
        <p className="text-xl">
          Welcome to <strong className="text-blue-500">SparkChat</strong> – a
          seamless, modern chat application designed to connect you with
        ...
        <div className="">
          <h2 className="text-xl md:text-2xl font-semibold mb-1 text-blue-500 ">
            Features
          </h2>
        ...
        <div className="">
          ...
          <p className="">
            To Contact us{" "}
            <span className="text-blue-500">sparkchat2024@gmail.com</span>
          </p>
        </div>
      </div>
    </div>
